...
- 基因组坐标是“物理位置”的标签，例如chr1:500-900 这个坐标区间，同时包含了正链上的500-900这段序列和负链上与之互补的500-900这段序列。它们是同一段双螺旋的两面。    
- 假设 chr1:500-505 的正链序列是： 5'-ATGCGA-3'      
那么，负链上对应位置（chr1:500-505）的序列就是它的互补反向： 3'-TACGCT-5'，通常书写为 5'-TCGCAT-3'（从5'到3'方向读）。位置：无论是说正链的 chr1:500-505 还是负链的 chr1:500-505，指的都是染色体1上第500到第505个碱基对这个物理区域。     
